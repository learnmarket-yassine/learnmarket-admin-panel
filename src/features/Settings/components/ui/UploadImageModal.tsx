    ...
    <>
      ...
      >
        <DialogTrigger asChild>
          <Button
            variant={'outline'}
            className="flex h-full items-center gap-2 rounded-lg border border-[#2563EB] px-6 py-2 text-sm font-semibold text-[#2563EB] hover:border-[#2563EB] hover:text-[#2563EB]"
          >
          ...
          <div className="flex flex-1 items-start gap-8">
            ...
            <div className="flex w-full flex-col items-center justify-center space-y-20">
              <h1 className="text-4xl font-bold text-[#1F2937]">
                Show the best version of yourself to other users!
              </h1>
