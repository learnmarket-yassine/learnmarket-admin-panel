    ...
    >
      <InputOTP maxLength={6} value={otpValue} onChange={setOtpValue}>
        <InputOTPGroup className="flex w-full justify-between gap-3">
          <InputOTPSlot
            className="h-[60px] w-[60px] rounded-full border border-[#8E949F] text-2xl font-medium text-[#2563EB]"
            index={0}
          />
          <InputOTPSlot
            className="h-[60px] w-[60px] rounded-full border border-[#8E949F] text-2xl font-medium text-[#2563EB]"
      ...
      <div className="mt-8 flex flex-col gap-11">
        <Button
          type="submit"
          className="h-full w-full whitespace-nowrap rounded-full bg-[#2563EB] py-2 font-medium text-white hover:bg-blue-700"
        >
          Verify
        </Button>
      </div>
