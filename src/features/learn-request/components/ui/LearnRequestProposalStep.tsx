...
import useGetLearnRequestProposals, {
  PROPOSALS_PAGE_SIZE,
} from '../../hooks/useGetLearnRequestProposals'
import LearnRequestProposalsList from './LearnRequestProposalsList'
...
const LearnRequestProposalStep = ({ learnRequestId, status }: LearnRequestProposalStepProps) => {
  ...
  const { data, isLoading, isError, refetch } = useGetLearnRequestProposals(
    learnRequestId,
    page,
    debouncedSearch,
    PROPOSALS_PAGE_SIZE
