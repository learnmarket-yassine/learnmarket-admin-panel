...
interface GetLearnRequestProposalsResponse {
  paginatedResult: Proposal[]
  totalCount: number
}

function useGetLearnRequestProposals(
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<GetLearnRequestProposalsResponse> => {
...
export default useGetLearnRequestProposals
