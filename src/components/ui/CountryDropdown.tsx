...
const CountryDropdownComponent = (
  ...
  const [selectedCountry, setSelectedCountry] = useState<Country | undefined>(() =>
    defaultValue ? options.find((country) => country.name === defaultValue) : undefined
  )
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <div className="flex flex-col gap-2">
        {label && (
          <Label className="text-sm font-semibold text-[#1F2937] peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
        ...
        <PopoverTrigger ref={ref} className={triggerClasses} disabled={disabled} {...props}>
          {selectedCountry ? (
            <div className="flex w-0 flex-grow items-center gap-2 overflow-hidden">
              <div className="inline-flex h-5 w-5 shrink-0 items-center justify-center overflow-hidden rounded-lg">
